...
#WorkingDir=$1
#RunName=$2
runNum=$( expr $num \* 10 + $ARA_Seeds )
echo b_$num_$Seeds.txt
echo /fs/project/PAS0654/BiconeEvolutionOSC/AraSim/ARA_bicone6in_output.txt
./AraSim setup.txt outputs/ b_${num}.txt /fs/project/PAS0654/BiconeEvolutionOSC/AraSim/ARA_bicone6in_output.txt > /fs/project/PAS0654/BiconeEvolutionOSC/BiconeEvolution/current_antenna_evo_build/XF_Loop/Evolutionary_Loop/Antenna_Performance_Metric/AraOut_ActualBicone.txt
